import React, { useEffect, memo, useMemo, useState, useReducer } from "react"
...
const AboutPage = () => {
  ...
  const statsData = useMemo(() => [
    ...
    },
    {
      icon: Globe,
      color: "from-[#6366f1] to-[#a855f7]",
      value: `${YearExperience} . ${MonthsExperience}`,
      label: "Years of Experience",
      description: "Continuous learning journey",
      animation: "fade-left",
    },
  ], [totalProjects, totalCertificates, YearExperience, MonthsExperience]);
      ...
      <div className="w-full mx-auto pt-8 sm:pt-12 relative">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              className="text-base sm:text-lg text-gray-400 leading-relaxed text-justify pb-4 sm:pb-0"
              data-aos="fade-right"
              data-aos-duration="1500"
            >
